...
export default function Revolution(props){
  ...
  return(
    <GridBox container direction="column">
      ...
      <RowGrid item container direction="row" alignItems="center">
        <GridBox item lg>
      ...
      <RowGrid item container direction="row" alignItems="center">
        ...
        <GridBox item container justifyContent="flex-end" lg>
      ...
      <RowGrid item container direction="row" style={{backgroundColor: "#B3B3B3", height: "90em"}}>
        <GridBox item container direction="column" lg>
          <GridBox item>
      ...
      <RowGrid item container direction="row" style={{backgroundColor: "#FF7373", height: "90em"}}>
        <GridBox item container direction="column" lg>
          <GridBox item>
      ...
      <RowGrid item container direction="row" style={{backgroundColor: "#39B54A", height: "90em"}}>
        <GridBox item container direction="column" lg>
          <GridBox item>
      ...
      <RowGrid item container direction="row" style={{backgroundColor: "#A67C52", height: "90em"}}>
        <GridBox item container direction="column" lg>
          <GridBox item>
      ...
      <RowGrid item container direction="row" style={{backgroundColor: "#FBB03B", height: "90em"}}>
        <GridBox item container direction="column" lg>
          <GridBox item>
      ...
      <RowGrid item container direction="row" style={{backgroundColor: "#C1272D", height: "90em"}}>
        <GridBox item container direction="column" lg>
          <GridBox item>
      ...
      <RowGrid item container direction="row" style={{backgroundColor: "#8E45CE", height: "90em"}}>
        <GridBox item container direction="column" lg>
          <GridBox item>
      ...
      <RowGrid item container direction="row" style={{backgroundColor: "#29ABE2", height: "90em"}}>
        <GridBox item container direction="column" lg>
          <GridBox item>
