...
export default function Revolution(props){
  ...
  return(
    <GridBox container direction="column">
      <RowGrid item style={{marginTop: "2em"}}>
        <Typography align={matchesMD ? "center" : undefined} variant="h2" style={{fontFamily: "Pacifico"}}>The Revolution</Typography>
      </RowGrid>

      <RowGrid item container direction={matchesMD ? "column" : "row"} alignItems="center" style={{marginTop: "5em"}}>
        <GridBox item lg>
        ...
        <GridBox item container direction="column" lg style={{maxWidth: "40em"}}>
          <GridBox item>
          ...
          <GridBox item>
            <Typography variant="body1" align={matchesMD ? "center" : "right"}>
              The rise of computers, and subsequently the Internet, has completely altered every aspect of human life. This has increased our comfort, broadened out connections, and reshaped how we view the world.
            </Typography>
            <Typography variant="body1" align={matchesMD ? "center" : "right"}>
            ...
            <Typography variant="body1" align={matchesMD ? "center" : "right"}>
              We want to help businesses capitalize on the latest and greatest technology. The best way to predict the future is to be the one building it, and we want to help guide the world into this next chapter of tecnologogical expansion, exploration, and innovation.
            </Typography>
            <Typography variant="body1" align={matchesMD ? "center" : "right"}>
      ...
      <RowGrid item container direction={matchesMD ? "column" : "row"} alignItems="center" style={{marginTop: "10em", marginBottom: "10em"}}>
        <GridBox item container direction="column" lg style={{maxWidth: "40em"}}>
          <GridBox item>
          ...
          <GridBox item>
            ...
            <Typography variant="body1" align={matchesMD ? "center" : undefined}>
              Instead of chaining together long individual pages, like traditional websites, Reat websites are built with little chunks of code called components. These components are faster, easier to maintain, and are easily reused and customized, each serving a singular purpose.
            </Typography>
            <Typography variant="body1" align={matchesMD ? "center" : undefined}>
              Two years later they shocked the world by releasing a similar system, React Native, for producing iOS and Android apps. Instead of having to master two completely separate development platforms, you can leverage the knowledge you already possessed from building websites and reapply it directly! This was a huge leap forware.
            </Typography>
            <Typography variant="body1" align={matchesMD ? "center" : undefined}>
            ...
            <Typography variant="body1" align={matchesMD ? "center" : undefined}>
              These technical advancements translate into savings by significantly reducing the workload and streamling the workflow for developming new pieces of software, while also lowering the barrier to entery for mobile app development.
            </Typography>
            <Typography variant="body1" align={matchesMD ? "center" : undefined}>
              This puts peronalization in your pocket - faster, better, and more affordable than ever before.
            </Typography>
          </GridBox>
        </GridBox>
        <GridBox item container justifyContent={matchesMD ? "center" : "flex-end"} lg>
          <CustomSoftwareSVG id="technologyAnimation" style={{maxWidth: "40em", margin: 0}}/>
        </GridBox>
      </RowGrid>

      <RowGrid item container direction="row" justifyContent="center">
        <GridBox item>
          <Typography variant="h4" gutterBottom>Process</Typography>
        </GridBox>
      </RowGrid>

      <RowGrid item container direction={matchesMD ? "column" : "row"} style={{backgroundColor: "#B3B3B3", height: "90em"}}>
        <GridBox item container direction="column" alignItems={matchesMD ? "center" : undefined} lg>
          <GridBox item>
          ...
          <GridBox item>
            <Typography variant="body1" align={matchesMD ? "center" : undefined} paragraph style={{color: "#fff", maxWidth: "20em"}}>
              Our process begins the moment you realize you need a piece of technology for your business. Whether you already have an idea for where to start and what to do, or if you just know you want to step things up, outinitial consultation will help you examine your business holistically to find the best solutions.
            </Typography>
            <Typography variant="body1" align={matchesMD ? "center" : undefined} paragraph style={{color: "#fff", maxWidth: "20em"}}>
            ...
            <Typography variant="body1" align={matchesMD ? "center" : undefined} paragraph style={{color: "#fff", maxWidth: "20em"}}>
              Cutting-edge advancements in machine learning like object detection and natural language processing allow computers to do things previously unimaginable, and and out expertise and intuition will help usher you into this new future of possibilities.
            </Typography>
          </GridBox>
        </GridBox>
        <GridBox item lg style={{alignSelf: "center"}}>
          <img src={consultation} alt="handshake" width="100%" style={{maxWidth: 700}}/>
        </GridBox>
      </RowGrid>

      <RowGrid item container direction={matchesMD ? "column" : "row"} style={{backgroundColor: "#FF7373", height: "90em"}}>
        <GridBox item container direction="column" alignItems={matchesMD ? "center" : undefined} lg>
          <GridBox item>
          ...
          <GridBox item>
            <Typography variant="body1" align={matchesMD ? "center" : undefined} paragraph style={{color: "#fff", maxWidth: "20em"}}>
              After we settle on the best path foraward and decide on a solution to pursue details like the cost and timeline wil be finalized.
            </Typography>
            <Typography variant="body1" align={matchesMD ? "center" : undefined} paragraph style={{color: "#fff", maxWidth: "20em"}}>
      ...
      <RowGrid item container direction={matchesMD ? "column" : "row"} style={{backgroundColor: "#39B54A", height: "90em"}}>
        <GridBox item container direction="column" alignItems={matchesMD ? "center" : undefined} lg>
          <GridBox item>
            <Typography variant="h4" align={matchesMD ? "center" : undefined} gutterBottom style={{color: "#000", marginTop: "5em"}}>Review</Typography>
          </GridBox>
          <GridBox item>
            <Typography variant="body1" align={matchesMD ? "center" : undefined} paragraph style={{color: "#fff", maxWidth: "20em"}}>
            ...
            <Typography variant="body1" align={matchesMD ? "center" : undefined} paragraph style={{color: "#fff", maxWidth: "20em"}}>
              We give you an interative demonstration of the mockups,thoroughly explaining the thought process that went into each screen and every anticipated feature.
            </Typography>
            <Typography variant="body1" align={matchesMD ? "center" : undefined} paragraph style={{color: "#fff", maxWidth: "20em"}}>
      ...
      <RowGrid item container direction={matchesMD ? "column" : "row"} style={{backgroundColor: "#A67C52", height: "90em"}}>
        <GridBox item container direction="column" alignItems={matchesMD ? "center" : undefined} lg>
          <GridBox item>
            <Typography variant="h4" align={matchesMD ? "center" : undefined}gutterBottom style={{color: "#000", marginTop: "5em"}}>Design</Typography>
          </GridBox>
          <GridBox item>
            <Typography variant="body1" align={matchesMD ? "center" : undefined}paragraph style={{color: "#fff", maxWidth: "20em"}}>
              Using the mockups and notes taken during the consultatioon as gyides, we will start ironing out what the final product will look like. This also involves using any brand material like fonts, colors, and logog to extend the experience you're already familiar with.
            </Typography>
            <Typography variant="body1" align={matchesMD ? "center" : undefined}paragraph style={{color: "#fff", maxWidth: "20em"}}>
      ...
      <RowGrid item container direction={matchesMD ? "column" : "row"} style={{backgroundColor: "#39B54A", height: "90em"}}>
        <GridBox item container direction="column" alignItems={matchesMD ? "center" : undefined} lg>
          ...
          <GridBox item>
            <Typography variant="body1" align={matchesMD ? "center" : undefined} paragraph style={{color: "#fff", maxWidth: "20em"}}>
              A second round of review is essentail to our goal of creating exactly what you want, exactly how you want it.
            </Typography>
            <Typography variant="body1" align={matchesMD ? "center" : undefined} paragraph style={{color: "#fff", maxWidth: "20em"}}>
      ...
      <RowGrid item container direction={matchesMD ? "column" : "row"} style={{backgroundColor: "#FBB03B", height: "90em"}}>
        <GridBox item container direction="column" alignItems={matchesMD ? "center" : undefined} lg>
          <GridBox item>
            <Typography variant="h4" align={matchesMD ? "center" : undefined} gutterBottom style={{color: "#000", marginTop: "5em"}}>Build</Typography>
          </GridBox>
          <GridBox item>
            <Typography variant="body1" align={matchesMD ? "center" : undefined} paragraph style={{color: "#fff", maxWidth: "20em"}}>
      ...
      <RowGrid item container direction={matchesMD ? "column" : "row"} style={{backgroundColor: "#C1272D", height: "90em"}}>
        <GridBox item container direction="column" alignItems={matchesMD ? "center" : undefined} lg>
          <GridBox item>
            <Typography variant="h4" align={matchesMD ? "center" : undefined} gutterBottom style={{color: "#000", marginTop: "5em"}}>Launch</Typography>
          </GridBox>
          <GridBox item>
            <Typography variant="body1" align={matchesMD ? "center" : undefined}paragraph style={{color: "#fff", maxWidth: "20em"}}>
      ...
      <RowGrid item container direction={matchesMD ? "column" : "row"} style={{backgroundColor: "#8E45CE", height: "90em"}}>
        <GridBox item container direction="column" alignItems={matchesMD ? "center" : undefined} lg>
          <GridBox item>
            <Typography variant="h4" align={matchesMD ? "center" : undefined}gutterBottom style={{color: "#000", marginTop: "5em"}}>Maintain</Typography>
          </GridBox>
          <GridBox item>
            <Typography variant="body1" align={matchesMD ? "center" : undefined}paragraph style={{color: "#fff", maxWidth: "20em"}}>
      ...
      <RowGrid item container direction={matchesMD ? "column" : "row"} style={{backgroundColor: "#29ABE2", height: "90em"}}>
        <GridBox item container direction="column" alignItems={matchesMD ? "center" : undefined} lg>
          <GridBox item>
            <Typography variant="h4" align={matchesMD ? "center" : undefined} gutterBottom style={{color: "#000", marginTop: "5em"}}>Iterate</Typography>
          </GridBox>
          <GridBox item>
            <Typography variant="body1" align={matchesMD ? "center" : undefined} paragraph style={{color: "#fff", maxWidth: "20em"}}>
